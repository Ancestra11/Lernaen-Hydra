...
try:
    #keep_window_open = Options()
    #keep_window_open.add_experimental_option("detach", True)
    #webdriver.Chrome(keep_window_open, service=Service(ChromeDriverManager().install()))
